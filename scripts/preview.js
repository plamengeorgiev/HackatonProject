 ...
 function initializeArray(){
	...
	{name: "Storm",
	 ...
	 todo: ['Постарайте се да сте далече от високи дървета, от електропроводи и метални предмети!'
	 ,'Ако сте на открито, не лягайте и не докосвайте земята с ръце. Клекнете!'
	 ,'Дръжте се на разтояние от съседа си!'
